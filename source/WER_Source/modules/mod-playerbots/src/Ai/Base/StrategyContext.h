...
public:
    StrategyContext()
    {
        ...
        creators["pitch in"] = &StrategyContext::pitch_in;
        creators["idle life"] = &StrategyContext::idle_life;
        creators["guide"] = &StrategyContext::wl_guide;
...
private:
    ...
    static Strategy* debug_grind(PlayerbotAI* botAI) { return new WlDebugGrindStrategy(botAI); }
    static Strategy* pitch_in(PlayerbotAI* botAI) { return new WlPitchInStrategy(botAI); }
    static Strategy* idle_life(PlayerbotAI* botAI) { return new WlIdleLifeStrategy(botAI); }
    static Strategy* wl_guide(PlayerbotAI* botAI) { return new WlGuideStrategy(botAI); }
