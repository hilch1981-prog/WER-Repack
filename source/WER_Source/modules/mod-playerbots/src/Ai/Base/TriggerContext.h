...
public:
    TriggerContext()
    {
        ...
        creators["wl idle"] = &TriggerContext::wl_idle;
        creators["wl idle seldom"] = &TriggerContext::wl_idle_seldom;
        creators["wl master sitting"] = &TriggerContext::wl_master_sitting;
        creators["wl guide active"] = &TriggerContext::wl_guide_active;
...
private:
    ...
    // WL "idle life" cadences: mean ~20s strolls, ~60s ambient emotes
    static Trigger* wl_idle(PlayerbotAI* botAI) { return new RandomTrigger(botAI, "wl idle", 10); }
    static Trigger* wl_idle_seldom(PlayerbotAI* botAI) { return new RandomTrigger(botAI, "wl idle seldom", 30); }
    static Trigger* wl_master_sitting(PlayerbotAI* botAI) { return new WlMasterSittingTrigger(botAI); }
    static Trigger* wl_guide_active(PlayerbotAI* botAI) { return new WlGuideActiveTrigger(botAI); }
