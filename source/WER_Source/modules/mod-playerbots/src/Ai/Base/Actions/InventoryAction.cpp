        ...
        if (proto->Class != oldClass)
        {
            ...
            switch (proto->Class)
            {
                ...
                case ITEM_CLASS_ARMOR:
                    botAI->TellMaster("--- 방어구 ---");
                    break;
                case ITEM_CLASS_REAGENT:
                    botAI->TellMaster("--- 재료 ---");
                    break;
                case ITEM_CLASS_PROJECTILE:
                    botAI->TellMaster("--- 투사체 ---");
                    break;
                case ITEM_CLASS_TRADE_GOODS:
                    botAI->TellMaster("--- 직업용품 ---");
                    break;
                case ITEM_CLASS_RECIPE:
                    botAI->TellMaster("--- 조제법 ---");
                    break;
                case ITEM_CLASS_QUIVER:
                    botAI->TellMaster("--- 화살통 ---");
                    break;
                case ITEM_CLASS_QUEST:
                    botAI->TellMaster("--- 퀘스트 아이템 ---");
                    break;
                case ITEM_CLASS_KEY:
                    botAI->TellMaster("--- 열쇠 ---");
                    break;
...
std::vector<Item*> InventoryAction::parseItems(std::string const text, IterateItemsMask mask)
{
    ...
    // Upstream 7e9de982 (Terry Raimondo): validate the qualifier before stoi.
