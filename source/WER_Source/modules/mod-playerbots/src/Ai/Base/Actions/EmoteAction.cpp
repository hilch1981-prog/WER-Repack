    ...
    switch (emote)
    {
        ...
        case 325:
            if (botAI->GetMaster() == source)
            {
                ...
                botAI->TellMasterNoFacing("알겠어요. 여기서 기다릴게요.");
            }
            break;
        ...
        case 324:
            if (botAI->GetMaster() == source)
            {
                ...
                botAI->TellMasterNoFacing("어디든 따라갈게요.");
            }
            break;
        ...
        case TEXT_EMOTE_JOKE:
            ...
            emoteText = "아직 웃을 때가 아니었나요?";
            break;
        case TEXT_EMOTE_CHICKEN:
            emoteText = "누가 겁쟁이인지 곧 알게 되겠죠!";
        ...
        case TEXT_EMOTE_SCRATCH:
            ...
            emoteYell = "아야! 정말 아프잖아요!";
            break;
        case TEXT_EMOTE_BORED:
            emoteId = EMOTE_ONESHOT_NO;
            textEmote = TEXT_EMOTE_NO;
            emoteText = "지금은 놀아 드릴 시간이 없어요.";
            break;
        case TEXT_EMOTE_BOW:
        ...
        case TEXT_EMOTE_EYEBROW:
            emoteId = EMOTE_ONESHOT_QUESTION;
            textEmote = TEXT_EMOTE_SHRUG;
            emoteText = "저를 보지 마세요. 전 그냥 따라온 거예요.";
            break;
        ...
        case TEXT_EMOTE_BREATH:
            ...
            emoteId = EMOTE_ONESHOT_POINT;
            textEmote = TEXT_EMOTE_POINT;
            emoteText = "으악! 가까이 오지 마세요!";
            break;
        case TEXT_EMOTE_CRY:
            emoteId = EMOTE_ONESHOT_CRY;
            textEmote = TEXT_EMOTE_CRY;
            emoteText = "울지 마세요. 저도 따라 울 것 같잖아요!";
            break;
        case TEXT_EMOTE_CRACK:
            emoteId = EMOTE_ONESHOT_ROAR;
            textEmote = TEXT_EMOTE_ROAR;
            emoteText = "이제 제대로 싸워 봅시다!";
            break;
        case TEXT_EMOTE_EAT:
        case TEXT_EMOTE_DRINK:
            emoteId = EMOTE_ONESHOT_EAT;
            textEmote = TEXT_EMOTE_EAT;
            emoteText = "모두 나눠 먹을 만큼 가져왔겠죠?";
            break;
        ...
        case TEXT_EMOTE_EMBARRASS:
            emoteId = EMOTE_ONESHOT_CRY;
            textEmote = TEXT_EMOTE_CRY;
            emoteText = "그렇다고 그렇게 무례할 필요는 없잖아요.";
            break;
        case TEXT_EMOTE_HUNGRY:
            emoteId = EMOTE_ONESHOT_EAT;
            textEmote = TEXT_EMOTE_EAT;
            emoteText = "왜요? 한판 해 보자는 건가요?";
            break;
        ...
        case TEXT_EMOTE_LISTEN:
            ...
            emoteText = "그래서 말인데요, 제 얘기도 좀 들어 보세요.";
            break;
        ...
        case TEXT_EMOTE_INSULT:
            emoteId = EMOTE_ONESHOT_CRY;
            textEmote = TEXT_EMOTE_CRY;
            emoteText = "마음이 좀 상했어요.";
            break;
        case TEXT_EMOTE_JK:
            emoteId = EMOTE_ONESHOT_POINT;
            textEmote = TEXT_EMOTE_POINT;
            emoteText = "바로 당신 말이에요.";
            break;
        case TEXT_EMOTE_RAISE:
            emoteId = EMOTE_ONESHOT_POINT;
            textEmote = TEXT_EMOTE_POINT;
            emoteText = "네, 뒤에 있는 당신이요.";
            break;
        ...
        /*case TEXT_EMOTE_BADFEELING:
            ...
            bot->Say("이제 불길한 음악만 나오면 딱 맞겠네요.", LANG_UNIVERSAL);
            break;
        case TEXT_EMOTE_MAP:
            bot->HandleEmoteCommand(EMOTE_ONESHOT_NO);
            bot->Say("이럴 수가... 길을 물어보면 될 일을요.", LANG_UNIVERSAL);
            break;
        case TEXT_EMOTE_IDEA:
        case TEXT_EMOTE_THINK:
            bot->HandleEmoteCommand(EMOTE_ONESHOT_NO);
            bot->Say("세상에... 또 기막힌 생각이군요.", LANG_UNIVERSAL);
            break;
        case TEXT_EMOTE_OFFER:
            bot->HandleEmoteCommand(EMOTE_ONESHOT_NO);
            bot->Say("괜찮아요. 지난 마을에서 이미 먹었어요.", LANG_UNIVERSAL);
            break;
        case TEXT_EMOTE_PET:
            bot->HandleEmoteCommand(EMOTE_ONESHOT_ROAR);
            bot->Say("제가 개처럼 보여요?!", LANG_UNIVERSAL);
            break;
        case TEXT_EMOTE_ROLLEYES:
            bot->HandleEmoteCommand(EMOTE_ONESHOT_POINT);
            bot->Say("계속 그러면 눈이 빠지겠어요.", LANG_UNIVERSAL);
            break;
        case TEXT_EMOTE_SING:
            bot->HandleEmoteCommand(EMOTE_ONESHOT_APPLAUD);
            bot->Say("좋네요... 정말 좋네요.", LANG_UNIVERSAL);
            break;
        case TEXT_EMOTE_COVEREARS:
            bot->HandleEmoteCommand(EMOTE_ONESHOT_EXCLAMATION);
            bot->Yell("그게 도움이 될 것 같아요?!", LANG_UNIVERSAL);
            break;*/
        default:
            // return false;
            // bot->HandleEmoteCommand(EMOTE_ONESHOT_QUESTION);
