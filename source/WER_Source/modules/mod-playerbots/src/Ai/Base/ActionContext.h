...
public:
    ActionContext()
    {
        ...
        creators["pitch in attack"] = &ActionContext::pitch_in_attack;
        creators["wl idle stroll"] = &ActionContext::wl_idle_stroll;
        creators["wl campfire spot"] = &ActionContext::wl_campfire_spot;
        creators["wl idle emote"] = &ActionContext::wl_idle_emote;
...
private:
    ...
    static Action* pitch_in_attack(PlayerbotAI* botAI) { return new WlPitchInAttackAction(botAI); }
    static Action* wl_idle_stroll(PlayerbotAI* botAI) { return new WlIdleStrollAction(botAI); }
    static Action* wl_campfire_spot(PlayerbotAI* botAI) { return new WlCampfireSpotAction(botAI); }
    static Action* wl_idle_emote(PlayerbotAI* botAI) { return new WlIdleEmoteAction(botAI); }
