...
public:
    ChatActionContext()
    {
        ...
        creators["wl guide"] = &ChatActionContext::wl_guide;
        creators["wl guide move"] = &ChatActionContext::wl_guide_move;
...
private:
    ...
    static Action* wl_guide(PlayerbotAI* botAI) { return new WlGuideAction(botAI); }
    static Action* wl_guide_move(PlayerbotAI* botAI) { return new WlGuideMoveAction(botAI); }
