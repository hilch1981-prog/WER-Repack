...
public:
    ChatTriggerContext()
    {
        ...
        creators["wl guide"] = &ChatTriggerContext::wl_guide;
...
private:
    ...
    static Trigger* hearthstone(PlayerbotAI* botAI) { return new ChatCommandTrigger(botAI, "hearthstone"); }
    ...
    static Trigger* wl_guide(PlayerbotAI* botAI) { return new ChatCommandTrigger(botAI, "wl guide"); }
