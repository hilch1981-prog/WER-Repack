...
bool PossibleTargetsValue::AcceptUnit(Unit* unit)
{
    ...
    if (unit->IsPlayer())
    {
        ...
        // WOW Legends: all-zones World PvP - bots engage enemy players
        // regardless of the level gap, so starting/leveling zones are live PvP
        // too (the level filter below otherwise refuses higher-level players
        // and only 25%-engages much lower ones). Capitals above + the core
        // sanctuary gate still keep cities damage-safe.
