...
bool PlayerbotAIConfig::Initialize()
{
    ...
    wlArrivalScatterRadius = sConfigMgr->GetOption<float>("AiPlayerbot.WlArrivalScatterRadius", 12.0f);
    ...
    greetChance = std::min<uint32>(100, sConfigMgr->GetOption<uint32>("AiPlayerbot.GreetChance", 5));
