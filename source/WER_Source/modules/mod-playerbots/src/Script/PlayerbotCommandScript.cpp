...
public:
    ...
    static bool HandleSetSecurityKeyCommand(ChatHandler* handler, char const* args)
    {
        if (!args || !*args)
        {
            handler->PSendSysMessage("사용법: .playerbots account setKey <securityKey>");
            return false;
        }
        ...
        {
            handler->PSendSysMessage("플레이어봇 관리자를 찾을 수 없습니다.");
            return false;
        }
    }
    ...
    static bool HandleLinkAccountCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (!accountName || !key)
        {
            handler->PSendSysMessage("사용법: .playerbots account link <accountName> <securityKey>");
            return false;
        }
    ...
    static bool HandleUnlinkAccountCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (!accountName)
        {
            handler->PSendSysMessage("사용법: .playerbots account unlink <accountName>");
            return false;
        }
