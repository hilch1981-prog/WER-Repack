...
public:
    ...
    // WL: radius in yards used to scatter random-teleport arrivals so bots sent to the same
    // destination no longer stack on one coordinate. 0 restores the old exact-landing behaviour.
    float wlArrivalScatterRadius;
